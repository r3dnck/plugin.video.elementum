...
class NoRedirectHandler(urllib_request.HTTPRedirectHandler):
    def http_error_302(self, req, fp, code, msg, headers):
        infourl = urllib_response.addinfourl(fp, headers, headers["Location"], code)
...
def normalizeLabels(labels):
    ...
    extra_labels = [
        "artbanner", "artclearart", "artclearlogo", "artfanart",
        "artfanarts", "artlandscape", "artposter", "artthumb",
        "dbtype", "icon", "is_playable", "label", "label2", "thumbnail"
    ]
